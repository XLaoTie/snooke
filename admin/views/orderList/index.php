        ...
        <div class="box-search">
            <form action="<?php echo Yii::app()->request->url;?>" method="get">
                ...
                <label style="margin-right:10px;">
                    <span>关键字：</span>
                    <input style="width:200px;" class="input-text"   placeholder="请输入订单编码/客户名字"type="text" name="keywords" value="<?php echo Yii::app()->request->getParam('keywords');?>">
                </label>
            ...
            <table class="list">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $model->getAttributeLabel('order_code');?></th>
                         <th><?php echo $model->getAttributeLabel('entry_code');?></th>
                        <th><?php echo $model->getAttributeLabel('entry_date');?></th>
                ...
                <tbody>
                    ...
                    <tr>  
                      ...
                      <td><?php echo CHtml::link($v->order_code, array('update', 'id'=>$v->id)); ?></td>
                       <td><?php echo $v->entry_code; ?></td>
                     <td><?php  echo $v->entry_date; ?></td>
                     <td><?php  echo $v->client_name;?></td>
                     
                     
                      <td><?php echo $v->cloth_code; ?></td>
