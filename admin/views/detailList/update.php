    <div class="box">
    <div class="box-title c"><h1><i class="fa fa-table"></i>信息修改</h1><span class="back"><a class="btn" href="javascript:;" onclick="we.back();"><i class="fa fa-reply"></i>返回</a></span></div><!--box-title end-->
            ...
            <div style="display:block;" class="box-detail-tab-item">
                ...
                <table>
                	<tr class="table-title">
                    	<td colspan="6">服装信息明细</td>
                    </tr>

                       <tr>
                        <td><?php echo $form->labelEx($model, 'date'); ?></td>
                        <td colspan="2">
                            <?php echo $form->textField($model, 'date', array('class' => 'input-text')); ?>
